...
<!-- 일부러 화면 깨지도록 HTML파일로만 구성! -->

<script>
/*
 ajax 사용시 비동기 방식이므로
 http://localhost:9999/k11mybatis//mybatisJSON/deleteAction.do?idx=15
 요렇게 요청명으로 들어가서 변화 체크하기(에러발생시 대처, 여기서 500에러나면 걍 안되는겨)
 */
$(function() {
...
function reflash() {
	/*
	키보드의 F5이나 새로고침 버튼을 누른것과 동일하게 웹브라우져를 새로고침해서
